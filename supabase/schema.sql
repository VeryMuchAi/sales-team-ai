...
--        aprenda de ellas en regeneraciones futuras del mismo prospecto.
-- ============================================================

alter table public.prospects add column if not exists proposal_currency text default 'USD';
